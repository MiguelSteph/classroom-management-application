...
export class PendingRequestListComponent implements OnInit {
  ...
  rejectCurrentBookingRequest(reason) {
    this.bookingRequestService.rejectBookingRequest(this.currentBookingRequest['id'], reason)
      .subscribe(result => {
  ...
  approveCurrentBookingRequest() {
    this.bookingRequestService.approveBookingRequest(this.currentBookingRequest['id'])
      .subscribe(result => {
